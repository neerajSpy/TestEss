...
class GuesthouseBooking
{
    ...
    function bookingRequest($createdById,$checkIn,$checkOut,$paidViaId){
        
        if ($this->isRoomEmpty($checkIn, $checkOut)) {
            $result = $this->con->query("INSERT INTO `guest_bookings` (`check_in`,`check_out`,`paid_via_id`,`created_by_id`,`created_date`) 
            VALUES ('$checkIn','$checkOut','$paidViaId','$createdById','$this->date')");
